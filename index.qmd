...
- 2-step procedure:
  - **Augmented Inverse Propensity Weighting (AIPW)** transformation on the outcome
  - Project the transformed outcome on the covariates, test **joint significance of projection coefs**
- Test heterogeneity in ATE/LATE in the same framework
- Only requires standard outputs from statistical software
- Extending Double Machine Learning to deal with high-dimensional covariates
...
$$\begin{aligned}
&H_0: \tau(x) = 0 \quad &\rightarrow \quad H_0: \beta = 0\\
&H_0: \tau(x) \text{ is constant } \quad &\rightarrow \quad H_0: \beta_x = 0
\end{aligned}$$
...
- **$\hat\beta$ still follows the OLS asymptotic distribution**
...
- Design2-4: Survey data, <br>different nonlinearity in CATE
